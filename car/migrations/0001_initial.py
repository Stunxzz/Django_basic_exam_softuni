    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=15, validators=[django.core.validators.MinLengthValidator(1, 'Model must be at least 1 character long!')])),
                ...
                ('owner', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='car', to='profile.profile')),
            ],
        ),
    ]
